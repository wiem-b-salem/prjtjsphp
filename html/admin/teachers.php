                ...
                <tbody>
                    <?php foreach ($teachers as $teacher): ?>
                        <tr>
                            ...
                            <td>
                                <span class="status-badge status-<?php echo isset($teacher['status']) ? strtolower($teacher['status']) : 'inactive'; ?>">
                                    <?php echo isset($teacher['status']) ? ucfirst($teacher['status']) : 'Inactive'; ?>
                                </span>
                            </td>
                            <td class="action-buttons">
                                <?php if (isset($teacher['status']) && $teacher['status'] == 'active'): ?>
